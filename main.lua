...
local function createCleanGUI()
    ...
    local frameHeight = isMobile and 480 or 520
    ...
    contentFrame.CanvasSize = UDim2.new(0, 0, 0, isMobile and 430 or 440)
    ...
    treeSection.Size = UDim2.new(1, 0, 0, isMobile and 140 or 150)
    ...
    treeToggleButton.Position = UDim2.new(0, 15, 0, isMobile and 100 or 105)
    treeToggleButton.BackgroundColor3 = Color3.fromRGB(108, 117, 125)
    treeToggleButton.Text = "Destroy GUI"
    ...
    destroyButton.Size = UDim2.new(1, 0, 0, isMobile and 40 or 35)
    destroyButton.Position = UDim2.new(0, 0, 0, isMobile and 300 or 320)
...
local function toggleMinimize()
    ...
    local targetHeight = isMinimized and (gui.isMobile and 60 or 55) or (gui.isMobile and 480 or 520)
...
local function main()
    print("🚀 Starting Premium Aura Controller v5.1...")
    ...
    local success, result = pcall(function()
        ...
        print("✨ Premium Aura Controller v5.1 loaded successfully!")
